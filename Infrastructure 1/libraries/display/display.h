...
void displayNimGUIWithoutPlayerAndWait(bool playerTurn, int remainingMatches, int move, int delay);
void displayNimGameOver(bool playerWon);
void clearDisplay();

void displayCountdown(int number, int delay);
