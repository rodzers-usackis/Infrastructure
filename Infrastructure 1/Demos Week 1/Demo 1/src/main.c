...
{
    DDRB = 0b00110100; //Write a binary number to the Data Direction Register B. Pin 5 of port B is enabled for writing with this setting.
    ...
    while (1)
    {
        PORTB = (0 << (PB2 + 2)); //We write a 0 to PB+3 to let the connected LED light up.
        _delay_ms(500); //We use the _delay_ms(..) function from delay.h to pause the execution during 1000 milliseconds (1 sec).
