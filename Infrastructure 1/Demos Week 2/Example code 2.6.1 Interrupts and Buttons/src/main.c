...
ISR( PCINT1_vect )
{
    ...
    if ( bit_is_clear( BUTTON_PIN, BUTTON_1 ))
    {
...
int main()
{
    ...
    BUTTON_DDR &= ~_BV( BUTTON_1 );          // we'll use button1
    BUTTON_PORT |= _BV( BUTTON_1 );          // enable pull-up
    ...
    PCMSK1 |= _BV( BUTTON_1 );   /* In the corresponding Pin Change Mask Register: indicate
