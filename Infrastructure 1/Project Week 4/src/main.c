...
int main() {
  ...
  cli();
  lightDownAllLeds();
  disableDisplay(); // to look prettier
  
  currentSpeed <= 5 ? victory() : defeat(); // Could've also combined them into one function and chosen which sound to play based on gameWon boolean.
